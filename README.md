...
設定瀏覽器代理到 127.0.0.1:8080 如果需要的話請用firefox-esr 將proxy到該位置 請注意 如果想使用wsl docker 進行映射, 要注意 kali-linux 內部要用主機ip 而非127.0.0.1

利用proxy 的intercept去進行攔截請求並修改值來對後台發送攻擊
